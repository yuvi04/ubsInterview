...
import com.ubs.opsit.interviews.BerlinClockTimeFormat;

/**
 * A class to fully encapsulates all of the JBehave plumbing behind a builder
 * style API. The expected use for this would be:
 * {code}aBehaviouralTestRunner().usingStepsFrom(this).withStory("your.story").
 * run(){code}
 *
 */
public final class BehaviouralTestEmbedder extends ConfigurableEmbedder {
	...
	public BehaviouralTestEmbedder usingStepsFrom(Object... stepsSource) {
		...
		stepsFactory = new InstanceStepsFactory(configuration(), stepsSource, new BerlinClockTimeFormat());
		return this;
	}
